    ...
    <div data-testid="session-sidebar" className="flex flex-col h-full">
      ...
      <div className="px-3 py-3">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-soul/10 text-soul hover:bg-soul/20 transition-colors text-sm font-semibold cursor-pointer"
        >
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span
                        ...
                        className="opacity-0 group-hover:opacity-100 focus:opacity-100 shrink-0 w-5 h-5 flex items-center justify-center rounded text-fg-muted hover:text-fail hover:bg-fail/10 transition-all cursor-pointer"
                      >
